...
export default function GroupStats({
  ...
  return (
    ...
    >
      <Card
        className={`${color} border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 bg-white dark:bg-gray-800`}
      >
